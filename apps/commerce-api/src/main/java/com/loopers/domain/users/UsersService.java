...
public class UsersService {
    ...
    @Transactional
    public UsersEntity join(final UsersCommand usersCommand) {
        UsersEntity entity = usersCommand.toEntity();
    ...
    private void validationDuplicateId(final UsersEntity entity) {
